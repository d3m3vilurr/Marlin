...
static void setup_for_endstop_move(bool force_enable_endstop=false) {
  ...
  static void run_z_probe() {
    ...
    #if ENABLED(DELTA) && ENABLED(FSR_BED_LEVELING)
...
inline void gcode_G28() {
  ...
  inline void gcode_G29() {
    ...
    bool dryrun = code_seen('D'),
      ...
      #if DISABLED(DELTA) || ENABLED(FSR_BED_LEVELING)
    ...
    #elif ENABLED(Z_PROBE_ALLEN_KEY) || ENABLED(FSR_BED_LEVELING) //|| SERVO_LEVELING
      stow_z_probe();
    #endif
